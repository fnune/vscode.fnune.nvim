...
theme.set_highlights = function(opts)
    ...
    hl(0, 'VertSplit', { fg = c.vscLeftDark })
    ...
    hl(0, 'Pmenu', { fg = c.vscPopupFront, bg = 'NONE' })
    hl(0, 'PmenuSel', { fg = 'NONE', bg = c.vscPopupHighlightBlue })
    hl(0, 'PmenuSbar', { bg = c.vscBack })
    hl(0, 'PmenuThumb', { fg = c.vscLeftMid, bg = c.vscLeftMid })
    ...
    hl(0, 'NormalFloat', { bg = c.vscBack })
    hl(0, 'FloatBorder', { fg = c.vscLeftDark })
    ...
    hl(0, '@punctuation.delimiter.jsdoc', { fg = c.vscGray, bg = 'NONE' })
    hl(0, '@comment', { fg = c.vscGray, bg = 'NONE', italic = opts.italic_comments })
    ...
    -- Dropbar
    hl(0, 'DropBarIconUIPickPivot', { link = '@comment.note' })

    -- visual-whitespace.nvim
    hl(0, 'VisualNonText', { fg = c.vscDisabledBlue, bg = c.vscSelection })
    ...
    if isDark then
        ...
        hl(0, 'TelescopePromptBorder', { fg = c.vscLeftDark })
        hl(0, 'TelescopeResultsBorder', { fg = c.vscLeftDark })
        hl(0, 'TelescopePreviewBorder', { fg = c.vscLeftDark })
